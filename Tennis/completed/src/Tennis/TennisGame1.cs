...
public class TennisGame1 : ITennisGame {
    private PlayerPoints1 player1Points;
    private PlayerPoints1 player2Points;

    public TennisGame1(string player1Name, string player2Name) {
        player1Points = new PlayerPoints1(player1Name);
        player2Points = new PlayerPoints1(player2Name);
    }
...
public class PlayerPoints1 {
    public int Points {get; private set; }
    public string PlayerName { get; private set; }

    public PlayerPoints1(string playerName) {
