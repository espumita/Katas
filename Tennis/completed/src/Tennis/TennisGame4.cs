...
public class TennisGame4 : ITennisGame {
    private PlayerPoints4 player1Points;
    private PlayerPoints4 player2Points;

    public TennisGame4(string player1Name, string player2Name) {
        player1Points = new PlayerPoints4(player1Name);
        player2Points = new PlayerPoints4(player2Name);
    }
...
public class PlayerPoints4 {
    public int Points {get; private set; }
    public string PlayerName { get; private set; }

    public PlayerPoints4(string playerName) {
