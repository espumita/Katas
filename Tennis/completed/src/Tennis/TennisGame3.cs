...
public class TennisGame3 : ITennisGame {
    private PlayerPoints3 player1Points;
    private PlayerPoints3 player2Points;

    public TennisGame3(string player1Name, string player2Name) {
        player1Points = new PlayerPoints3(player1Name);
        player2Points = new PlayerPoints3(player2Name);
    }
...
public class PlayerPoints3 {
    public int Points { get; private set; }
    public string PlayerName { get; private set; }

    public PlayerPoints3(string playerName) {
