...
public class TennisGame5 : ITennisGame {
    private PlayerPoints5 player1Points;
    private PlayerPoints5 player2Points;

    public TennisGame5(string player1Name, string player2Name) {
        player1Points = new PlayerPoints5(player1Name);
        player2Points = new PlayerPoints5(player2Name);
    }
...
public class PlayerPoints5 {
    public int Points {get; private set; }
    public string PlayerName { get; private set; }

    public PlayerPoints5(string playerName) {
